...
_TELEGRAM_MENU_DESCRIPTIONS_RU: dict[str, str] = {
    ...
    "branch": "Ответвить диалог в новую ветку",
    "compress": "Сжать контекст текущего диалога",
    "rollback": "Показать или восстановить чекпоинт",
    "stop": "Остановить фоновые процессы",
    "approve": "Разрешить опасную команду",
    "deny": "Отклонить опасную команду",
    "background": "Запустить задачу в фоне",
    "btw": "Задать короткий вопрос по контексту",
    "queue": "Поставить запрос в очередь",
    "status": "Показать статус сессии",
    "profile": "Показать активный профиль",
    "sethome": "Сделать этот чат основным",
    "resume": "Продолжить прошлый диалог",
    "config": "Показать текущие настройки",
    "model": "Сменить модель для диалога",
    "provider": "Показать доступных провайдеров",
    "personality": "Выбрать характер ассистента",
    "statusbar": "Переключить строку статуса",
    "verbose": "Сменить режим показа действий",
    "yolo": "Переключить режим без подтверждений",
    "reasoning": "Настроить глубину рассуждений",
    "fast": "Переключить быстрый режим",
    "skin": "Сменить тему оформления",
    "voice": "Настроить голосовой режим",
    "tools": "Управление инструментами",
    "toolsets": "Показать наборы инструментов",
    "skills": "Найти или установить навык",
    "cron": "Управление задачами по расписанию",
    "reload-mcp": "Перезагрузить MCP-серверы",
    "browser": "Подключить браузер Chrome",
    "plugins": "Показать установленные плагины",
    ...
    "paste": "Прикрепить картинку из буфера",
...
def telegram_bot_commands() -> list[tuple[str, str]]:
    ...
    for cmd in COMMAND_REGISTRY:
        ...
        if tg_name:
            result.append((tg_name, _TELEGRAM_MENU_DESCRIPTIONS_RU.get(cmd.name, cmd.description)))
