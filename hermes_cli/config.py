...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "VK_HOME_CHANNEL", "VK_HOME_CHANNEL_NAME", "VK_POLL_INTERVAL",
    "VK_APPROVAL_CODE", "VK_ENV_PATH", "VK_GATEWAY_STATE_PATH",
...
OPTIONAL_ENV_VARS = {
    ...
    "VK_GROUP_TOKEN": {
        "description": "VK community access token with messages permissions",
        "prompt": "VK community token",
        "url": "https://vk.com/dev/access_token",
        "password": True,
        "category": "messaging",
    },
    "VK_ALLOWED_USERS": {
        "description": "Comma-separated numeric VK user IDs allowed to use the bot",
        "prompt": "Allowed VK user IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "VK_ALLOW_ALL_USERS": {
        "description": "Allow all VK users to interact with the bot (true/false). Default: false.",
        "prompt": "Allow all VK users (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
